...
public class HomeTransportadorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_transportador);
        ...
        new Thread(() -> {
            ...
            try {
                ...
                Request request = new Request.Builder()
                        .url("http://10.0.2.2:8080/pedidos/transportador")
                        .build();
                ...
                runOnUiThread(() ->
                        txtPedidos.setText("Erro ao carregar pedidos")
                );
        ...
        btnAceitar.setOnClickListener(v -> {
            ...
            txtPedidos.setText("Nenhum pedido pendente");

            Toast.makeText(
                    HomeTransportadorActivity.this,
                    "Pedido aceito!",
                    Toast.LENGTH_SHORT
            ).show();
